...
export default class WildseaDicePool extends FormApplication {
  ...
  activateListeners(html) {
    const submitBtn = html.querySelector('.submit'); if (submitBtn) submitBtn.addEventListener('click', this.handleSubmit.bind(this));
    const cancelBtn = html.querySelector('.cancel'); if (cancelBtn) cancelBtn.addEventListener('click', this.handleCancel.bind(this));
